...
namespace CapaDatos
{
    public class DPresentacion
    {
        ...
        public DPresentacion(int idpresentacion, string sigla, string descripcion, string textobuscar)
        {
        ...
        public string Insertar(DPresentacion Presentacion)
        {
            ...
            try
            {
                ...
                SqlParameter ParSigla = new SqlParameter();
                ParSigla.ParameterName = "@sigla";
                ParSigla.SqlDbType = SqlDbType.VarChar;
                ParSigla.Size = 50;
                ParSigla.Value = Presentacion.Sigla;
                SqlCmd.Parameters.Add(ParSigla);
